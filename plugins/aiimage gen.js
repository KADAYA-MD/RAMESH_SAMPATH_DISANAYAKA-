...
async (conn, mek, m, { from, q, reply }) => {
    try {
        if (!q) return reply(`
*🤖 𝐊𝐀𝐃𝐀𝐘𝐀 𝐌𝐃 𝐀𝐈 𝐈𝐌𝐀𝐆𝐄 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐎𝐑 🖼️*

Usage: .Hashi <image description>
Example: .Hashi Beautiful landscape with mountains

> ⚜️𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 : 𝐊𝐀𝐃𝐀𝐘𝐀 𝐌𝐃 💚*
`);
        await m.react("🔄");
        ...
        await conn.sendMessage(from, {
            image: response.data,
            caption: `*𝐊𝐀𝐃𝐀𝐘𝐀 𝐌𝐃  𝐀𝐈 𝐈𝐌𝐀𝐆𝐄 𝐆𝐄𝐍𝐄𝐑𝐀𝐓𝐎𝐑 🖼️*
...
`,
        ...
        console.error("Queen Hashi Image Generation Error:", error);
